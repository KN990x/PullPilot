...
export default function ProgressBar({ t, progress }) {
  ...
  return (
    // sticky, so it stays visible during a long update instead of scrolling away.
    <div className="bg-blue-600 text-white px-6 py-3 shadow-md transition-all duration-300 sticky top-0 z-20">
